<div class="nk-block-head">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title"><?= translate('Registered Companies') ?></h3>
            ...
            <div class="toggle-wrap nk-block-tools-toggle">
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                        ...
                        <li><label for="import-companies" class="btn btn-white btn-outline-light"><em class="icon ni ni-update"></em><span><?= translate('Import') ?></span></label></li>
                        <!-- <li><a href="/api/approved/new" class="btn btn-primary"><em class="icon ni ni-plus"></em></a></li> -->
                        <form id="upload-form">
                            <input type="file" name="file" class="d-none" id="import-companies" accept=".csv">
                        </form>
                        <li>
                            <div class="nk-block-head-content">
