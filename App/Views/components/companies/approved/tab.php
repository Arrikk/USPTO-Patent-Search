...
<div class="nk-block nk-block-lg">
    <div class="card">
        <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#personal-info"><em class="icon ni ni-user-circle-fill"></em><span><?= translate('Approved') ?></span></a>
            </li>
            <li class="nav-item">
        ...
        <div class="card-inner">
            <div class="tab-content">
                <div class="tab-pane active" id="personal-info">
                    <div class="nk-block">
                        <?php 
                            View::component('companies/approved/body');
                        ?>
                    </div><!-- .nk-block -->
                </div><!-- tab pane -->
                <div class="tab-pane" id="profile-overview">
                    <?php
                        View::component('companies/approved/new');
                    ?>
                    <!--tab content-->
                </div>
                <!--card inner-->
