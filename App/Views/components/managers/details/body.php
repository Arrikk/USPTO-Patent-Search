            ...
            <div class="row g-3 align-center">
                ...
                <div class="col-lg-7">
                    <div class="input-group">
                        <input type="number" value="" class="approval_code form-control" placeholder="<?= translate('Account Login') ?>" required="" disabled="">
                    </div>
                </div>
            </div>
            <div class="row g-3 align-center">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" value="" class="company_name form-control" required="" disabled="" placeholder="<?= translate('Pharmaceutical Company Name') ?>">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-lg-7 offset-lg-5">
                        <div class="form-group mt-2">
                            <button id="update-user" type="submit" class="btn btn-lg btn-primary"><?= translate('Update') ?></button>
                            <button id="delete-user" type="submit" class="btn btn-lg btn-danger"><?= translate('Delete') ?></button>
                        </div>
                    </div>
                </div>
            </div>
